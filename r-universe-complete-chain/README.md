...
- Manuscript release tag: `v1.5.3`
- GitHub package: <https://github.com/MartinPetrasek123/MartinPetrasek123/tree/main/r-universe-complete-chain>
- A Zenodo DOI should be minted from the `v1.5.3` GitHub release before journal submission. This draft does not invent or claim a DOI that has not been issued.
