...
def make_plots():
    ...
    plt.title("Expanzni historie pro Pantheon+ full + DESI DR2 + CC")
    plt.legend()
    plt.tight_layout()
    ...
    plt.ylabel("diagonalni BAO pull")
    plt.title("DESI DR2 BAO rezidua")
    plt.legend(ncol=3)
    plt.tight_layout()
    ...
    plt.title("Pantheon+ residualy po marginalizaci absolutni magnitudy")
    plt.legend()
    plt.tight_layout()
    ...
    plt.ylabel("R-Universe minus LCDM")
    plt.title("Modelova selekce: zaporne hodnoty preferuji R-Universe")
    plt.legend()
    plt.tight_layout()
