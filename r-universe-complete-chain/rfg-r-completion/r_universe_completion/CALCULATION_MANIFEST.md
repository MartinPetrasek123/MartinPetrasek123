...
| RFG-RXi finite-action solver kernel | `scripts/rfg_xi_finite_action_solver.py` | Implicit integration of the exact finite material DAE from a=1e-8 to a=1; action constraint, linearity, and exact GR-action-limit tests; not a CMB transfer solver |
